...
func TestPinsFieldTable(t *testing.T) {
	...
	tests := []struct {
		...
		{"upstream runner version", p.UpstreamRunner.Version, "v2.335.1"},
		{"upstream runner sha256", p.UpstreamRunner.LinuxX64SHA256, "4ef2f25285f0ae4477f1fe1e346db76d2f3ebf03824e2ddd1973a2819bf6c8cf"},
