...
func TestPinsExactValues(t *testing.T) {
	want := Manifest{
		...
		UpstreamRunner: UpstreamRunnerPin{
			...
			SourceTree:            "3789e2e60ae52fc9c45b78e0d7f436ee2526b6d5",
			SourceReleaseEvidence: "cfd5c4acaa59579ff850aaad8d4e3f614afc6f80853e870a5271de7db516ba7b",
...
func TestPinsFieldTable(t *testing.T) {
	...
	tests := []struct {
		...
		{"upstream runner source tree", p.UpstreamRunner.SourceTree, "3789e2e60ae52fc9c45b78e0d7f436ee2526b6d5"},
		{"upstream runner source release evidence", p.UpstreamRunner.SourceReleaseEvidence, "cfd5c4acaa59579ff850aaad8d4e3f614afc6f80853e870a5271de7db516ba7b"},
